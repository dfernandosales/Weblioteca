...
public class ReservaResourceIntTest {
    ...
    private static final LocalDate DEFAULT_DATA_RESEVA = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATA_RESEVA = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Reserva createEntity(EntityManager em) {
        Reserva reserva = new Reserva()
            .dataReseva(DEFAULT_DATA_RESEVA);
        return reserva;
    }
    ...
    public void createReserva() throws Exception {
        ...
        assertThat(testReserva.getDataReseva()).isEqualTo(DEFAULT_DATA_RESEVA);
    }
    ...
    @Test
    @Transactional
    public void checkDataResevaIsRequired() throws Exception {
        int databaseSizeBeforeTest = reservaRepository.findAll().size();
        // set the field null
        reserva.setDataReseva(null);
    ...
    public void getAllReservas() throws Exception {
        ...
        restReservaMockMvc.perform(get("/api/reservas?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dataReseva").value(hasItem(DEFAULT_DATA_RESEVA.toString())));
    }
    ...
    public void getReserva() throws Exception {
        ...
        restReservaMockMvc.perform(get("/api/reservas/{id}", reserva.getId()))
            ...
            .andExpect(jsonPath("$.dataReseva").value(DEFAULT_DATA_RESEVA.toString()));
    }
    ...
    public void updateReserva() throws Exception {
        ...
        updatedReserva
            .dataReseva(UPDATED_DATA_RESEVA);
        ...
        Reserva testReserva = reservaList.get(reservaList.size() - 1);
        assertThat(testReserva.getDataReseva()).isEqualTo(UPDATED_DATA_RESEVA);
    }
