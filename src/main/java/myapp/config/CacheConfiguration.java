...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(myapp.domain.PersistentToken.class.getName(), jcacheConfiguration);
            cm.createCache(myapp.domain.User.class.getName() + ".persistentTokens", jcacheConfiguration);
